...
[GitHub](https://github.com/bugfishtm/Android-Web-App-Example){.md-button}
...
[Download](https://github.com/bugfishtm/Android-Web-App-Example/archive/refs/heads/main.zip){.md-button}
